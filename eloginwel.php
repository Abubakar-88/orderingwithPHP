...
<html>
<head>
	<title>Employee Panel | MicroTech NA</title>
...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="empProductOrder.php?id=<?php echo $id?>">Product Order</a></li>
	...
	<div id="divimg">
	<div>
	    <h2 style="text-align:right; font-size:20px;margin-right:35px;">Employee Id:<?php echo " $id"; ?> </h2>
		 <h2 style="text-align:center;">Welcome <?php echo "$empName"; ?> </h2> 
