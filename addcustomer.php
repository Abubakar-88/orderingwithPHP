    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="addcustomer.php">Add Customer</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Registration Customer Info</h2>
                    <form action="process/addcustprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="BIRTHDATE" name="birthday" required="required">
