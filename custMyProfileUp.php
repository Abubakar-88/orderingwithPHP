...
if(isset($_POST['update']))
{
 ...
 $result = mysqli_query($conn, "UPDATE `customer` SET `email`='$email',`contact`='$contact',`address`='$address' WHERE id=$id");

 echo ("<SCRIPT LANGUAGE='JavaScript'>

    window.location.href='custMyProfile.php?id= $id';
    </SCRIPT>");
...
<html>
<head>
  <title>Update Profile | MicroTech NA</title>
  <!-- Icons font CSS-->
...
<body>
  <header>
    <nav>
      ...
      <ul id="navli">
        ...
        <li><a class="homered" href="custMyProfile.php?id=<?php echo $id?>">My Profile</a></li>
  ...
  <div class="divider"></div>
    ...
    <!-- <form id = "registration" action="custMyProfileUp" method="POST"> -->
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="custMyProfileUp.php" method="POST">
                    ...
                    <br>
                    <button class="btn btn--radius btn--green" onclick="window.location.href = 'changePassCuatomer.php?id=<?php echo $id?>';">Change Password</button>
                </div>
            </div>
        </div>
    </div>
